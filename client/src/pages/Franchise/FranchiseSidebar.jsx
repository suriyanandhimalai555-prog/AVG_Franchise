      ...
      `}>
        ...
        <div className="h-16 px-6 flex items-center justify-between border-b border-slate-800/80 mt-2">
          <div className="flex items-center gap-3">
            <img src={Logo} alt="AVG Logo" className="w-9 h-9 bg-white border border-slate-300 rounded-lg shrink-0" />
            <div className="min-w-0">
              <span className="text-sm font-bold text-white tracking-tight block truncate">AVG Franchise</span>
              <span className="text-[10px] font-medium text-slate-500 mt-0.5 block truncate">Branch Portal</span>
            </div>
          </div>
        ...
        {/* Branch Info & Sign Out */}
        <div className="p-3 border-t border-slate-800/80 space-y-2">
          <div className="px-3 py-2 bg-slate-800/50 rounded-xl border border-slate-800 text-[11px]">
            <div className="flex items-center gap-2 text-slate-300 font-semibold">
              <Store className="w-3.5 h-3.5 text-blue-400 shrink-0" />
              <span className="truncate">North Outlet #101</span>
            </div>
            <div className="text-[10px] text-slate-500 mt-0.5">ID: FR-NORTH-01</div>
          </div>
          <NavLink
            to="/login"
