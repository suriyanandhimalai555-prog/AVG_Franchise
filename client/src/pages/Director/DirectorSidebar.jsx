...
const directorNavItems = [
  { label: 'Dashboard', path: '/director/dashboard', icon: BarChart3 },
  { label: 'Territory Performance', path: '/director/territories', icon: MapPin },
        ...
        <div className="h-16 px-6 flex items-center justify-between border-b border-slate-800/80 mt-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-medium text-slate-500 mt-1 block">Director Panel</span>
            </div>
          </div>
