...
const FranchiseLayout = () => {
  ...
  return (
    <div className="h-screen w-full bg-slate-50 flex overflow-hidden text-slate-800 antialiased">
      {/* Sidebar Navigation */}
      <FranchiseSidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 pl-1">
              ...
              <div className="hidden sm:block text-left">
                <div className="text-xs font-bold text-slate-800 leading-tight">North Branch Outlet</div>
                <div className="text-[10px] text-slate-400 font-medium">Branch Owner</div>
              </div>
            </div>
          </div>
        </header>
